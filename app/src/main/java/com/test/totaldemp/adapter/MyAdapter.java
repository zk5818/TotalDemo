...
import com.test.totaldemp.helper.OnDragVHListener;
import com.test.totaldemp.helper.OnItemMoveListener;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>
    ...
    RecyclerViewOnItemMovedListener onItemMovedListener;
...
//            itemView.setBackgroundResource(R.color.c_42B377);
        }
...
//        holder.cardView.setCardBackgroundColor(Color.parseColor(color[position % color.length]));
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        ...
        onItemMovedListener.onItemMovedListener(fromPosition, toPosition);
    }
    ...
    public void setOnItemMovedListener(RecyclerViewOnItemMovedListener onItemMovedListener) {
    ...
    public interface RecyclerViewOnItemMovedListener {

        boolean onItemMovedListener(int fromPosition, int toPosition);
